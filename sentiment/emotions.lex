...
gratitude: grateful|gratitude|thankful|generous|heartwarming|"heart warming" # no thanks!
...
grief: grief|grieving|grieved|tragedy|aggrieved|anguish|suffer|suffering|sepulchral|mourn|mourning|condolence|bereave|sympathy|sympathies|heartbroken|"heart broken"|"last rites"|"sad news"|condolence|condolences|heartbreak|heartbroken|sorrow|heartbroken|heartbreak

posEmo: {wow}|{gratitude}|{pride}|{joy}|{nice}|{pos-surprise}|{humor} # no likes
negEmo: {shame}|{disappointment}|{emotion}|{anxiety}|{sorry}|{pity}|{worry}|{embarassment}|{contempt}|{destructive}|{hate}|{jealousy}|{dislike}|{despair}|{fear}|{shock}|{sadness}|{conflict}|{guilt}
